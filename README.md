...
<table>
<tr>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/02-view-mode.png" alt="View mode"><br><small><b>View mode</b> - the header is gone, even under the mouse; only the data is on the wall.</small></td>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/03-edit-mode.png" alt="Edit mode"><br><small><b>Edit mode</b> - the header is back the moment you edit, so the widget stays as configurable as it was.</small></td>
</tr>
</table>
